                    ...
                    <table id="dataTable" class="min-w-full text-sm text-left border border-green-300 rounded-lg">
                        <thead class="bg-green-700 text-white">
                            <tr>
                                ...
                                <th class="py-3 px-6">Label Petugas</th>
                                ...
                                <tr class="odd:bg-white even:bg-green-50 hover:bg-green-200">
                                    ...
                                    <td class="py-3 px-6">
                                        @if ($p->label_petugas)
                                            {{ $p->label_petugas }}
                                        @else
                                            <span class="text-gray-500 italic">Nonaktif</span>
                                        @endif
                                    </td>
                                    <td class="py-3 px-6">{{ str_repeat('*', min(strlen($p->password), 8)) }}</td>
                                    <td class="py-3 px-6">
